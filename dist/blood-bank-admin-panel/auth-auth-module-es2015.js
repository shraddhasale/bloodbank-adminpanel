...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AuthModule, { declarations: [_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_4__["RegisterComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _auth_routing_module__WEBPACK_IMPORTED_MODULE_2__["AuthRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]] }); })();
...
/* harmony import */ var _const_storage_key_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @const/storage-key.constant */ "l+V9");
/* harmony import */ var _login_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login-http.service */ "Qqas");
...
class LoginComponent {
    constructor(_loginHttp, _router) {
    ...
    onLoginClick(username, password) {
        this.isLoading = true;
        this.invalidLogin = false;
        this.subscriptions.add(this._loginHttp
...
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_login_http_service__WEBPACK_IMPORTED_MODULE_4__["LoginHttpService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"])); };
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 27, vars: 2, consts: [[1, "login-page", "col-md-12", "h-100"], [1, "row", "justify-content-md-center", "h-100"], [1, "col-md-6", "bg-white", "d-flex", "flex-wrap", "align-items-center", "justify-content-center", "h-100"], [1, "login-container"], [1, "font-weight-bold", "text-center", "font-xxxl"], [1, "text-primary"], [1, "col-md-12", "px-0"], ["name", "form", 3, "ngSubmit"], ["f", "ngForm"], [1, "form-content"], [1, "form-group"], ["type", "text", "placeholder", "Phone Number", "required", "", 1, "form-control"], ["username", ""], ["type", "password", "placeholder", "Password", "required", "", 1, "form-control"], ["password", ""], [1, "form-group", "text-right"], ["class", "text-danger mt-4 text-left", 4, "ngIf"], ["type", "submit", 1, "btn", "btn-sm", "btn-primary", "mt-2", "py-2", "px-4", "color-white", "text-uppercase"], ["class", "spinner-border spinner-border-sm align-middle", 4, "ngIf"], [1, "text-danger", "mt-4", "text-left"], [1, "spinner-border", "spinner-border-sm", "align-middle"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _login_http_service__WEBPACK_IMPORTED_MODULE_4__["LoginHttpService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }]; }, null); })();
